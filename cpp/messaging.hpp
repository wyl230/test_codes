...
public:
  ...
  ~TemplateDispatcher() noexcept(false) {
    ...
    if (!chained) {
      wait_and_dispatch();
      print("not chained! TemplateDispatcher wait_and_dispatch");
    }

    print("chained! TemplateDispatcher wait_and_dispatch");
  }
};
...
public:
  ...
  ~dispatcher() noexcept(false) {
    ...
    if (!chained) {
      wait_and_dispatch();
      print("not chained! dispatch wait_and_dispatch");
    }
    print("chained! dispatch wait_and_dispatch");
  }
};
