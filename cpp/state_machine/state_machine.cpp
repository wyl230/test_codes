...
class close_queue {
public:
  close_queue(const close_queue &) = default;
  close_queue(close_queue &&) = delete;
  close_queue &operator=(const close_queue &) = default;
  close_queue &operator=(close_queue &&) = delete;
  virtual ~close_queue() = default;
};
